...
#Messenger Token
PAT = 'EAATpd4YvnZCABAGhAZBFB6uQ4KbWkZCkI8lc524KDDBfFnP2ZAZChRmNZCRcjZB9DlXKwt5UZAgtxQF3YIe540ZBBZAh8FyO9ZBCR1iZAYKFCWIqWB7Cq6W7Uqb0jZCPGAlg3Duv2ePGazeeIxAiTkU60U8MJ1RIYKdu2nTvyZCjpFtGDnzgZDZD'

#API.AI Token
CLIENT_ACCESS_TOKEN = '78f526e61f0b496da448be080414031a'

#Token that is confirmed by webhooks
VERIFY_TOKEN = 'ClayChatV1.5'
...
def handle_verification():
    ...
    if (request.args.get('hub.verify_token', '') == VERIFY_TOKEN):
        ...
        print("Wrong!")
        return "THATS NOT THE RIGHT TOKEN!"
...
def parse_user_message(user_text):
    ...
    if (responseStatus == 200):
        ...
        try:
            ...
            max_temp = str(w.get_temperature('fahrenheit')['temp_max'])
            min_temp = str(w.get_temperature('fahrenheit')['temp_min'])
            current_temp = str(w.get_temperature('fahrenheit')['temp'])
            wind_speed = str(w.get_wind()['speed'])
            humidity = str(w.get_humidity())

            weather_report = '\nCurrent temperature: ' + current_temp +'\nHigh/Low: ' + max_temp + ' - ' + min_temp +  '\nWind Speed :' +wind_speed+" mph"+ '\nHumidity ' + humidity + '%'
